 ...
 * @package    Adserver
 *
 * A pre-initialisation file to check if system settings allow Adserver
 * to be run or not.
 */
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <div class="logo_image">&nbsp;</div>
    <div class="error_container">';
        if ($installed) {
            $message .= "
      <h1>Sorry, but Adserver cannot currently run on your machine</h1>";
        } else {
            $message .= "
      <h1>Sorry, but the Adserver installer system cannot currently be started</h1>";
        }
        $message .= '
...
function RV_checkSystemInitialRequirements(&$aErrors){
    ...
    // run Adserver, apart from the functions:
    //
    //   - "function_exists"
    //   - "array_intersect"
    //   - "explode"
