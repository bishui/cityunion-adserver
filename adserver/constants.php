 ...
 * @package    Adserver
 *
 * A file to set up the environment constants for Adserver.
 */

/**
 * The environmental constants initialisation function for Adserver.
 */
function setupConstants()
{
    // Define this version of Adserver's constants
    define('VERSION', '5.0.5');
    define('PRODUCT_NAME', 'Adserver');
