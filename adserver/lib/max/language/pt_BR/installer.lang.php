...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Recuperando Adserver %s';
$GLOBALS['strInstallStatusInstall'] = 'Instalando Adserver %s';
$GLOBALS['strInstallStatusUpgrade'] = 'Atualizando para Adserver %s';
$GLOBALS['strInstallStatusUpToDate'] = 'Detectado Adserver %s';
