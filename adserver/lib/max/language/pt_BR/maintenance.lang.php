...
$GLOBALS['strAutoMantenaceEnabledAndHasntRun'] = "A Manutenção automática esta habilitada, mas não foi disparada. Ela é disparada somente quando o {$PRODUCT_NAME} entrega anúncios. Para uma melhor performance, você deve configurar <a href='{$PRODUCT_DOCSURL}/maintenance' target='_blank'>a manutenção agendada</a>";

$GLOBALS['strAutoMantenaceDisabledAndHasntRun'] = "A manutenção automática esta desabilitada, portanto quando o  {$PRODUCT_NAME} entregar banners, a manutenção automática não será disparada. Para a melhor performance você deve configurar a <a href='{$PRODUCT_DOCSURL}/maintenance' target='_blank'>manutenção agendada</a>. Porém, se você não for configurar a <a href='{$PRODUCT_DOCSURL}/maintenance' target='_blank'>manutenção agendada</a>, então você <i>deve</i> <a href='account-settings-maintenance.php'>habilitar a manutenção automática</a> para garantir que o {$PRODUCT_NAME} funcione corretamente.";

$GLOBALS['strAutoMantenaceEnabledAndRunning'] = "A Manutenção automática esta habilitada, mas não foi disparada. Ela é disparada somente quando o {$PRODUCT_NAME} entrega anúncios. Para uma melhor performance, você deve configurar <a href='{$PRODUCT_DOCSURL}/maintenance' target='_blank'>a manutenção agendada</a>";

$GLOBALS['strAutoMantenaceDisabledAndRunning'] = "Porém a manutenção automática foi desabilitada recentemente. Para garantir que o {$PRODUCT_NAME} funcione corretamente, você deve ou configurar <a href='{$PRODUCT_DOCSURL}/maintenance' target='_blank'>a manutenção agendada</a> ou <a href='account-settings-maintenance.php'>re-habilitar a manutenção automática</a>.<br><br>Para a melhor performance, você deve configurar <a href='{$PRODUCT_DOCSURL}/maintenance' target='_blank'>a manutenção agendada</a>.";
...
$GLOBALS['strServerCommunicationError'] = "<b>Comunicação com o servidor de atualização esgotou o tempo máximo, portanto o {$PRODUCT_NAME} não foi capaz de verificar se uma versão nova esta disponível. Tente novamente mais tarde.</b>";
