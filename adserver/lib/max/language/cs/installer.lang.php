...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Obnovení Adserver %s';
$GLOBALS['strInstallStatusInstall'] = 'Instalace Adserver %s';
$GLOBALS['strInstallStatusUpgrade'] = 'Upgrade Adserver %s';
$GLOBALS['strInstallStatusUpToDate'] = 'Zjištěn Adserver %s';
