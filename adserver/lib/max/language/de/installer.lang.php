...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Adserver %s wiederherstellen';
$GLOBALS['strInstallStatusInstall'] = 'Adserver %s installieren';
$GLOBALS['strInstallStatusUpgrade'] = 'Auf Adserver %s upgraden';
$GLOBALS['strInstallStatusUpToDate'] = 'Adserver %s gefunden';
