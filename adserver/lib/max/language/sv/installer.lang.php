...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Återställa Adserver %s';
$GLOBALS['strInstallStatusInstall'] = 'Installera ReviveAdserver %s';
$GLOBALS['strInstallStatusUpgrade'] = 'Uppgradera till Adserver %s';
$GLOBALS['strInstallStatusUpToDate'] = 'Upptäckte Adserver %s';
