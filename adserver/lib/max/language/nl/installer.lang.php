...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Adserver %s herstellen';
$GLOBALS['strInstallStatusInstall'] = 'Adserver %s installeren';
$GLOBALS['strInstallStatusUpgrade'] = 'Upgrade naar Adserver %s';
$GLOBALS['strInstallStatusUpToDate'] = 'Adserver %s gedetecteerd';
