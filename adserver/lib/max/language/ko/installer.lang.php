...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Adserver %s 복구중';
$GLOBALS['strInstallStatusInstall'] = 'Adserver %s 설치중';
$GLOBALS['strInstallStatusUpgrade'] = 'Adserver %s 업그레이드 중';
$GLOBALS['strInstallStatusUpToDate'] = 'Adserver %s 감지됨';
