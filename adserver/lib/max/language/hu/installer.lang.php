...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Adserver %s helyreállítása';
$GLOBALS['strInstallStatusInstall'] = 'Adserver %s telepítése';
$GLOBALS['strInstallStatusUpgrade'] = 'Adserver %s frissítése';
$GLOBALS['strInstallStatusUpToDate'] = 'Adserver %s törlése';
