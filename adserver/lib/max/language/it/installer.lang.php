...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Ripristino di Adserver %s';
$GLOBALS['strInstallStatusInstall'] = 'Installazione di Adserver %s';
$GLOBALS['strInstallStatusUpgrade'] = 'Aggiornamento a Adserver %s';
$GLOBALS['strInstallStatusUpToDate'] = 'Rilevato Adserver %s';
