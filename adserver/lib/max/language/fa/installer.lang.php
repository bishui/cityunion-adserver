...
$GLOBALS['strInstallStatusInstall'] = 'نصب کردن Adserver %s';
$GLOBALS['strInstallStatusUpgrade'] = 'تکامل Adserver %s';
$GLOBALS['strInstallStatusUpToDate'] = 'Adserver پیدا شده %s';
