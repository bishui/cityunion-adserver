...
/** status messages * */
$GLOBALS['strInstallStatusRecovery'] = 'Recovering Adserver %s';
$GLOBALS['strInstallStatusInstall'] = 'Installing Adserver %s';
$GLOBALS['strInstallStatusUpgrade'] = 'Upgrading to Adserver %s';
$GLOBALS['strInstallStatusUpToDate'] = 'Detected Adserver %s';
