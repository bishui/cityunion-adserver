...
$GLOBALS['phpAds_hlp_dbport'] = "Specify the number of the port of the {$phpAds_dbmsname} database server to which you are trying to connect.";
...
$GLOBALS['phpAds_hlp_table_type'] = "MySQL supports multiple table types. Each type of table has unique properties and some
...
is installed, for example: <i>http://www.your-url.com/ads</i>.";
...
is installed, for example: <i>https://www.your-url.com/ads</i>.";

$GLOBALS['phpAds_hlp_my_header'] = $GLOBALS['phpAds_hlp_my_footer'] = "You should put here the path to the header files (e.g.: /home/login/www/header.htm)
...
$GLOBALS['phpAds_hlp_admin_pw'] = $GLOBALS['phpAds_hlp_admin_pw2'] = "Please enter the password you want to use to log into the administrator interface.
You need to enter it twice to prevent typing errors.";

$GLOBALS['phpAds_hlp_pwold'] = $GLOBALS['phpAds_hlp_pw'] = $GLOBALS['phpAds_hlp_pw2'] = "To change the administrator password, you can need to specify the old
